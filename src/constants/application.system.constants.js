...
export const ccurriculumName = wrd.ccurriculum + wrd.cName; // curriculumName
export const ccurriculumIndex = wrd.ccurriculum + wrd.cIndex; // curriculumIndex
export const cCurriculumNumber = wrd.cCurriculum + wrd.cNumber; // CurriculumNumber
